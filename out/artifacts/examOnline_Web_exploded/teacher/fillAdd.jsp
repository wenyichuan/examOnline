                ...
                <ul class="nav nav-tabs nav-stacked">
                    ...
                    <li class="dropdown active"><a href=""><span class="iconfa-briefcase"></span> 试题管理</a>
                        <ul>
                            ...
                            <li class="actives"><a href="<%=path %>/teacher/fillAdd.jsp">添加填空题</a></li>
        ...
        <div class="rightpanel">
            ...
            <div class="maincontent">
                <div class="maincontentinner">
                    ...
                    <div class="widget">
                        <h4 class="widgettitle">添加填空题</h4>
                        <div class="widgetcontent">
                            <form class="stdform" action="fillAdd.action" method="post">

                                <p>
                                    <label>【课程名】题目</label>
                                    <span class="field"><input type="text" class="input-large" name="stTitle" size="80" placeholder="输入下划线表示空格" required="required"></span>
                                </p>

                                <p>
                                    <label>答案</label>
                                    <span class="field"><input type="text" name="stAnswer" class="input-large" placeholder="答案"required="required"></span>
                                </p>
