                ...
                <table id="dyntable" class="table table-bordered responsive">
			  	...
			  	<td colspan="6" align="center">
					...
					<s:if test="#request.page.hasPrePage">
						<a href="queryStudentByClass.action?currentPage=1&sclass=${request.sclass}">首页</a> |
                		<a href="queryStudentByClass.action?currentPage=${page.currentPage - 1}&sclass=${request.sclass}">上一页</a> |
               		</s:if>
					<s:else>
               		首页 | 上一页 | 
               		</s:else>
					<s:if test="#request.page.hasNextPage==true">
						<a href="queryStudentByClass.action?currentPage=${page.currentPage + 1}&sclass=${request.sclass}">下一页</a> |
                		<a href="queryStudentByClass.action?currentPage=${page.totalPage}&sclass=${request.sclass}">尾页</a>
					</s:if>
					<s:else>
               		下一页 | 尾页
               		</s:else>
