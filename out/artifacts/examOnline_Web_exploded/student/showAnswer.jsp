...
<div class="container">
			...
			<div class="examed_uc maincontentinner">
				<h3 style="text-align: center;">中北大学考试参考答案</h3>
				<br>
					<div>  
	        ...
	        <strong>【参考解析】：${subject.stParse}</strong>
					...
					<s:iterator value="#request.fills" var="fill" status="fil">
						<div class="question">
							...
							<p><strong>第<span class="STYLE5">${fil.index + 1}</span>题&nbsp;${fill.stTitle}</strong></p>

							<ul>
								<strong>【正确答案】：${fill.stAnswer}</strong><br/>
								<strong>【参考解析】：${fill.stParse}</strong>
