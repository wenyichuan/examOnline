...
<div class="container">
			...
			<div class="examed_uc maincontentinner">
				<h3 style="text-align: center;">中北大学考试</h3>
				<br>
					<div class = "exam_time">  
            <span>剩余时间为：</span><label  name="mss" id="mss"></label>   
				...
				<div class="questionCell" id="D_Title_P">
					...
					<div class="question">
						...
						<div class="titleBar">
							<span><b id="F_Title">填空题(100分)</b></span>
							<div class="clear"></div>
						</div>

						<s:iterator value="#request.fills" var="fill" status="fil">
							<div class="question">
								<input type="hidden" name="stID1" value="${fill.stID}" />
								<p>${fil.index + 1}、${fill.stTitle}（）&nbsp;(<span class="D_score">20.00</span>分)</p>
								<ul>
									<li>
										<input type="text" name="stAnswer1${fil.index}" id="answer" />
									</li>
					...
					<div align="center">
						<input type="submit" value=" 提交答卷 " name="Submit" onclick="return myfunction()"/>
					</div>
					</form>
