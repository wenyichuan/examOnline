...
<div class="mainwrapper">
            ...
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown active"><a href=""><span class="iconfa-briefcase"></span> 试题管理</a>
                    <ul>
                        ...
                        <li class="active"><a href="<%=path %>/teacher/fillQuery.jsp">搜索填空题</a></li></li>
                    </ul>
                </li>
    ...
    <div class="rightpanel">
        ...
        <div class="pageheader">
            <a href="<%=path %>/teacher/fillQueryByClass.jsp"><button >根据课程查找填空题</button></a>
        </div>
            ...
            <div class="maincontentinner">
                ...
                <div class="widget">
                    ...
                    <div class="widgetcontent">
                        <form class="stdform" action="queryFillLike.action" method="post">

                            <label>试题题目:</label>
                            <span class="field"><input type="text"  name="fillTitle"  class="input-xlarge" placeholder="请输入..." /></span>
