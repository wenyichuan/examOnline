...
<div class="mainwrapper">
            ...
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown active"><a href=""><span class="iconfa-briefcase"></span> 试题管理</a>
                    <ul>
                        ...
                        <li class="active"><a href="<%=path %>/teacher/queryFill.action">管理填空题</a></li>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="#">学生管理</a> <span class="separator"></span></li>
            <li>查询所有学生</li>
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                ...
                <table id="dyntable" class="table table-bordered responsive">
                    ...
                    <s:iterator value="#request.fills" var="fill">
                        <tr align="center">
                            <td>
                                    ${fill.stID}
                            </td>
                            ...
                            <td>
                                <a href="fillPaticular.action?stId=${fill.stID}">查看</a>
                            </td>
                            <td>
                                <a href="fillUpdateBefore.action?stId=${fill.stID}">更新</a>
                            </td>
                            <td>
                                <a href="fillDelete?stId=${fill.stID}">删除</a>
                            </td>
                        </tr>
                    </s:iterator>
                    <tr>
                        <td colspan="6" align="center">
                            ...
                            <s:if test="#request.page.hasPrePage">
                                <a href="queryFillLike.action?currentPage=1&fillTitle=${request.fillTitle}">首页</a> |
                                <a href="queryFillLike.action?currentPage=${page.currentPage - 1}&fillTitle=${request.fillTitle}">上一页</a> |
                            </s:if>
                            <s:else>
                                首页 | 上一页 |
                            </s:else>
                            <s:if test="#request.page.hasNextPage==true">
                                <a href="queryFillLike.action?currentPage=${page.currentPage + 1}&fillTitle=${request.fillTitle}">下一页</a> |
                                <a href="queryFillLike.action?currentPage=${page.totalPage}&fillTitle=${request.fillTitle}">尾页</a>
                            </s:if>
                            <s:else>
                                下一页 | 尾页
                            </s:else>
