        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown active"><a href=""><span class="iconfa-briefcase"></span> 试题管理</a>
                	<ul>
                    	<li class="actives"><a href="<%=path %>/teacher/subjectAdd.jsp">添加选择题</a></li>
						...
						<div class="widget">
							...
							<div class="widgetcontent">
								...
								<s:form action="outExcel" method="post">
									<s:submit value="导出选择题数据"></s:submit>
								</s:form>

								<s:form action="InExcel3" method="post" enctype="multipart/form-data">
