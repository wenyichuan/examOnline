            ...
            <div class="maincontentinner">
                ...
                <div class="widget">
                    ...
                    <div class="widgetcontent">
                        <form class="stdform" action="fillUpdate.action"  method="post">

                            <p>
                                <label>试题题目</label>
                                <span class="field">
						 <input name="stId" type="hidden" value="${fill.stID}">
						 <textarea name="stTitle" cols="80" rows="5" class="span5" >${fill.stTitle}</textarea>
						 </span>
                            </p>

                            <p>
                                <label>答案</label>
                                <textarea name="stAnswer" cols="80" rows="5" class="span5" >${fill.stAnswer}</textarea>

                            </p>
                            <p>
                                <label>试题解析</label>
                                <span class="field"><textarea cols="80" name="stParse" rows="5" class="span5" >${fill.stParse}</textarea></span>
                            </p>
