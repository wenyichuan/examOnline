...
//		}
		...
		for (Student student : students) {
			String newTitle =  student.getSclass().replaceAll(sclass, "<font color='red'>"+sclass+"</font>");//关键字标红
			student.setSclass(newTitle);
			newStudents.add(student);
		}


		request.setAttribute("students", newStudents);
